...
import { faArrowRightFromBracket, faCartShopping, faFileCircleCheck, faUser } from '@fortawesome/free-solid-svg-icons';
          ...
          <div className="right-section">
            {auth._id ? (
              <>
                ...
                <Link to="/orders">
                  <FontAwesomeIcon className='orders-icon' icon={faFileCircleCheck} />
                </Link>
              </>
            ) : (
              <Link to="/login">
